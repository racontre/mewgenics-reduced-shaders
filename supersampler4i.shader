...
struct vertex {
    ...
    void frag(){
        ...
        vec3 accum  = texelFetch(framebuf, pxcoord + ivec2(-2, -2), 0).rgb;
             accum += texelFetch(framebuf, pxcoord + ivec2(-1, -2), 0).rgb;
             accum += texelFetch(framebuf, pxcoord + ivec2(0, -2), 0).rgb;
             accum += texelFetch(framebuf, pxcoord + ivec2(1, -2), 0).rgb;

             accum += texelFetch(framebuf, pxcoord + ivec2(-2, -1), 0).rgb;
             accum += texelFetch(framebuf, pxcoord + ivec2(-1, -1), 0).rgb;
             accum += texelFetch(framebuf, pxcoord + ivec2(0, -1), 0).rgb;
             accum += texelFetch(framebuf, pxcoord + ivec2(1, -1), 0).rgb;

             accum += texelFetch(framebuf, pxcoord + ivec2(-2, 0), 0).rgb;
             accum += texelFetch(framebuf, pxcoord + ivec2(-1, 0), 0).rgb;
             accum += texelFetch(framebuf, pxcoord + ivec2(0, 0), 0).rgb;
             accum += texelFetch(framebuf, pxcoord + ivec2(1, 0), 0).rgb;
